      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            ...
            <img class="h-25 w-25" src="{{ asset('storage/logo') }}{{ '/'.$settings->logo }}" alt="{{ $settings->logo }}"></a>
          </div>
          ...
          <div class="col-8 text-right">
            <nav class="site-navigation" role="navigation">
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block mb-0">
                ...
                <li><a href="categoryes.html">Politics</a></li>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled float-left">
              ...
              <li><a href="{{ route('website.category', ['slug'=>$categoryes->slug]) }}">{{ ucfirst($categoryes->name) }}</a></li>
              @endforeach
            </ul>
          </div>
          <div class="col-md-4">
            ...
            <div>
              ...
              <p>
                <a target="_blank" href="{{ $settings->facebook }}"><span class="icon-facebook pt-2 pr-2 pb-2 pl-0"></span></a>
                <a target="_blank" href="{{ $settings->twitter }}"><span class="icon-twitter p-2"></span></a>
                <a target="_blank" href="{{ $settings->instagram }}"><span class="icon-instagram p-2"></span></a>
                <a target="_blank" href="{{ $settings->gmail }}"><span class="icon-envelope p-2"></span></a>
              </p>
            </div>
          </div>
        </div>
