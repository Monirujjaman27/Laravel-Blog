                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <a title="Back all Users" data-toggle="tooltip" href="{{ route('user.index') }} " class="badge badge-info p-2">Back User
                                Page</a>
                            <a title="Create New User" data-toggle="tooltip" href="{{ route('user.create') }} " class="float-right badge badge-primary p-2">Create New User</a>
                        </div>
                        <!-- /.card-header -->
                        <form action="{{ route('user.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="userRole">User Rolre <sup class="text-danger">*</sup></label>
